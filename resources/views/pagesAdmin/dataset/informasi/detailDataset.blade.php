        ...
        <div class="card shadow border-0 p-4 p-md-5 position-relative">
            <div class="d-flex justify-content-between pb-4 pb-md-5 mb-4 mb-md-5 border-bottom border-light">
                ...
                <div class="px-4">
                    ...
                    <ul class="list-group simple-list">
                        <li class="list-group-item fw-normal">{{ $rowFile->count() }}</li>
                        <li class="list-group-item fw-normal">New York, USA</li>
                        <li class="list-group-item fw-normal"><a class="fw-bold text-primary" href="#"><span
                                    class="__cf_email__"
                                    data-cfemail="0a6965677a6b64734a7e626f676f79686f786d24696567">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="mb-6 d-flex align-items-center justify-content-center">
                <h2 class="h4 mb-0">Ancaman Limbah Pabrik di Desa T</h2><span class="badge badge-lg bg-success ms-4">Unpublish</span>
            </div>
                ...
                <div class="col-sm">
                    ...
                    <div>
                        <ul class="list-group simple-list">
                            ...
                            <li class="list-group-item fw-normal">311 West Mechanic Lane Middletown, NY 10940
                            </li>
                            <li class="list-group-item fw-normal"><a class="fw-bold text-primary" href="#"><span
                                        class="__cf_email__"
                                        data-cfemail="6e000f030b2e0d01031e0f0017400d0103">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" class="text-left fw-bold h6">Custom Services</th>
                                ...
                                <tr>
                                    <th scope="row" class="text-left fw-bold h6">Hosting</th>
                                ...
                                <tr>
                                    <th scope="row" class="text-left fw-bold h6">Platinum Support</th>
                    ...
                    <h4>Payments to:</h4><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                            data-cfemail="6717061e0a0209132711080b134904080a">[email&#160;protected]</a></span>
                </div>
            </div>
        </div>
    </div>
